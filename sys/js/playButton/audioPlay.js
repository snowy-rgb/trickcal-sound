let komiSounds = [
    new Audio('../../../../assets/audio_but/버.m4a'), // 첫 번째 소리 파일
    new Audio('../../../../assets/audio_but/터.m4a')  // 두 번째 소리 파일
  ];
  let komIndex = 0;
...
let butterSounds = [
    new Audio('../../../../assets/audio_but/코.m4a'), // 첫 번째 소리 파일
    new Audio('../../../../assets/audio_but/미.m4a')  // 두 번째 소리 파일
  ];
  let buIndex = 0;
